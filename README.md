...
```
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-smoke-9174
```

A live public deployment of this template is available at [https://nameless-smoke-9174.templates.workers.dev](https://nameless-smoke-9174.templates.workers.dev)
